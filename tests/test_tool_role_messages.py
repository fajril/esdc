...
class TestToolRoleMessagesInStreaming:
    ...
    async def test_streaming_includes_tool_role_after_tool_calls(self):
        ...
        async def mock_events(*args, **kwargs):
            yield {"type": "token", "content": "I'll help you"}
            yield {
                "type": "message_complete",
                "ai_message": AIMessage(
                    content="I'll help you",
                    tool_calls=[{"name": "get_table", "args": {}, "id": "call_1"}],
                ),
            }
            yield {
                "type": "tool_result",
                "tool_name": "get_table",
                "result": "Table: reserves",
                "tool_call_id": "call_1",
            }
            yield {"type": "token", "content": "Here's the answer"}
        ...
        with (
            ...
            patch("esdc.server.agent_wrapper.create_agent"),
        ):
