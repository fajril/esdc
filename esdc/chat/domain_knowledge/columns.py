...
COLUMN_METADATA: dict[str, ColumnMetadata] = {
    ...
    # Summary columns (AI-generated, from resource_summaries table)
    "field_summary": ColumnMetadata(
        "field_summary",
        "AI-generated executive summary at field level. "
        "Sourced from resource_summaries table (entity_level='field'). "
        "Generated by summarizer: esdc summarize field --year <year>.",
        None,
        "summaries",
    ),
    "wk_summary": ColumnMetadata(
        "wk_summary",
        "AI-generated executive summary at working area level. "
        "Sourced from resource_summaries table (entity_level='working_area'). "
        "Generated by summarizer: esdc summarize working-area --year <year>.",
        None,
        "summaries",
    ),
    "nkri_summary": ColumnMetadata(
        "nkri_summary",
        "AI-generated executive summary at national (NKRI) level. "
        "Sourced from resource_summaries table (entity_level='nkri'). "
        "Generated by summarizer: esdc summarize nkri --year <year>.",
        None,
        "summaries",
    ),
    # Reserves columns
