...
ORDER BY report_year, wk_name, field_name, project_class, uncert_lvl;
...
FROM field_resources 
WHERE <where> LIKE '%<like>%' AND report_year = <year>
ORDER BY report_year, wk_name, field_name, project_stage, project_class, project_level, uncert_lvl;
...
FROM field_resources 
WHERE <where> LIKE '%<like>%' AND report_year = <year>
ORDER BY report_year, wk_name, field_name, project_stage, project_class, uncert_lvl;
