...
TABLE_CONFIGS: dict[str, dict] = {
    ...
    "documents": {
        ...
        "columns": [
            ...
            {"field": "wk_name", "title": "Working Area", "editable": True, "entityList": True, "headerFilter": True},
            {"field": "field_name", "title": "Field", "editable": True, "entityList": True, "headerFilter": True},
            {"field": "project_name", "title": "Project", "editable": True, "entityList": True, "headerFilter": True},
